...
from text.scrapers.scraper import NewspaperScraper  # noqa: E402
from text.scrapers.pipelines.storage import CSVStorage  # noqa: E402
...
@pytest.mark.parametrize(
    "config_path",
    [cfg for cfg in CONFIGS_DIR.rglob("*.yaml") if cfg.name != "template.yaml"],
