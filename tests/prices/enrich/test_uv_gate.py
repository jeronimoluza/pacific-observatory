...
def test_decide_rows_emits_uv_trusted():
    ...
    maps = (
        ...
        dict.fromkeys(names, 0.99),
        dict.fromkeys(names, True),
        dict.fromkeys(names, 0.97),
        set(),
    )
    out = decide_rows(products, *maps)
...
def test_item_basis_is_trusted_regardless_of_leaf():
    ...
    out = decide_rows(
        products,
        {"Paracetamol Tablets": "06.1.1.1"},
        {"Paracetamol Tablets": 0.99},
        {"Paracetamol Tablets": True},
        {"Paracetamol Tablets": 0.97},
        set(),
    )
...
def test_hierlex_writers_carry_uv_trusted():
    ...
    dec = decide_rows(
        products,
        {"Yoghurt 500g": "01.1.4.6.0", "Avodart 0.5mg": "06.1.1.1"},
        {"Yoghurt 500g": 0.99, "Avodart 0.5mg": 0.99},
        {"Yoghurt 500g": True, "Avodart 0.5mg": True},
        {"Yoghurt 500g": 0.97, "Avodart 0.5mg": 0.97},
        set(),
    )
