...
FETCHER_REGISTRY: dict[str, tuple] = {
    ...
    "kr_opinet_daily_avg": (fetch_kr_opinet_daily, date(2024, 1, 1), False),
    # Lao
    ...
    "th_eppo_retail_daily": (fetch_th_eppo_retail_daily, date(2024, 1, 1), False),
