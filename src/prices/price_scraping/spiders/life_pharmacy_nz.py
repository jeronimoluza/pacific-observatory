"""Spider for Life Pharmacy NZ (Shopify) - https://www.lifepharmacy.co.nz/"""
...
class LifePharmacyNzSpider(scrapy.Spider):
    name = "life_pharmacy_nz"
    allowed_domains = ["lifepharmacy.co.nz", "www.lifepharmacy.co.nz"]
