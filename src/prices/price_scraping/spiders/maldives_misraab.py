...
class MaldivesMisraabSpider(WooBaseSpider):
    name = "maldives_misraab"
    allowed_domains = ["misraab.com.mv"]
    BASE_URL = "https://misraab.com.mv/wp-json/wc/store/v1/products"
    currency = "MVR"
    language = "en"
