"""
Spider for Bargain Chemist (NZ pharmacy, Shopify) - https://www.bargainchemist.co.nz/
...
class BargainChemistSpider(scrapy.Spider):
    name = "bargain_chemist"
    allowed_domains = ["bargainchemist.co.nz", "www.bargainchemist.co.nz"]
