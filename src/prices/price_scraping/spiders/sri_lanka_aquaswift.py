...
class SriLankaAquaswiftSpider(WooBaseSpider):
    name = "sri_lanka_aquaswift"
    allowed_domains = ["aquaswift.lk"]
    BASE_URL = "https://aquaswift.lk/wp-json/wc/store/v1/products"
    currency = "LKR"
    language = "en"
