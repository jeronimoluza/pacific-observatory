"""
Spider for Courts Barbados (Unicomer Group) -- https://www.courts.com/barbados/.
...
999999/9999999/0 default-scope sentinel). This file covers Barbados
(store code sc_barbados_sv, BBD).
"""
...
_STORE_CODE = "sc_barbados_sv"
_SENTINEL_PRICES = {0, 999999, 9999999}


class CourtsBbSpider(MagentoRestBaseSpider):
    name = "courts_bb"
    ...
    PDP_BASE_URL = "https://www.courts.com/barbados/"
    PAGE_SIZE = 200
    MAX_PAGES = 300
