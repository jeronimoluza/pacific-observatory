"""
Spider for NZ Online Chemist (Shopify) - https://www.nzonlinechemist.co.nz/
...
class NzOnlineChemistSpider(scrapy.Spider):
    name = "nz_online_chemist"
    allowed_domains = ["nzonlinechemist.co.nz", "www.nzonlinechemist.co.nz"]
    base_url = "https://www.nzonlinechemist.co.nz"
    currency = "NZD"
    page_size = 250
