"""
Spider for Newby's Convenience (Isle of Man) - https://newbys.im/
Two Douglas convenience stores with an online grocery storefront on Shopify.
...
Currency is GBP: the Isle of Man uses the Manx pound at parity with sterling
and Shopify reports GBP for this shop, so the displayed "£" is unambiguous.
"""
...
class NewbysImSpider(scrapy.Spider):
    name = "newbys_im"
    allowed_domains = ["newbys.im"]
    base_url = "https://newbys.im"
    currency = "GBP"
    language = "en"
    page_size = 250
