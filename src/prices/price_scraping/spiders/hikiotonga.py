...
BASE = "https://www.hikiotonga.com/products.json"
PER_PAGE = 250
MAX_PAGES = 10


class HikiotongaSpider(scrapy.Spider):
    name = "hikiotonga"
    allowed_domains = ["www.hikiotonga.com"]
    currency = "USD"
    language = "en"
    ...
    def parse_page(self, response):
        ...
        logger.info(f"hikiotonga page={page} count={len(products)}")
        for p in products:
    ...
    def _items(self, p: dict):
        ...
        for v in variants:
            ...
            yield {
                ...
                "url": f"https://www.hikiotonga.com/products/{handle}?variant={v.get('id')}",
