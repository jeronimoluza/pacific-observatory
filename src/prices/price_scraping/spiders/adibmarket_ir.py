"""
Adibmarket (adibmarket.ir) — Iranian cosmetics/personal-care WooCommerce store.
...
class AdibmarketIrSpider(WooBaseSpider):
    name = "adibmarket_ir"
    allowed_domains = ["adibmarket.ir"]
    currency = "IRR"
    language = "fa"
    BASE_URL = "https://adibmarket.ir/wp-json/wc/store/v1/products"
    FORCE_CURRENCY = "IRR"
    PRICE_MULTIPLIER = 10
