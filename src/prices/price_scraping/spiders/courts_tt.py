"""
Spider for Courts Trinidad and Tobago (Unicomer Group) --
https://www.courts.com/trinidadandtobago/.
...
999999/9999999/0 default-scope sentinel). This file covers Trinidad and
Tobago (store code sc_trinidadandtobago_sv, TTD).
"""
...
_STORE_CODE = "sc_trinidadandtobago_sv"
_SENTINEL_PRICES = {0, 999999, 9999999}


class CourtsTtSpider(MagentoRestBaseSpider):
    name = "courts_tt"
    ...
    PDP_BASE_URL = "https://www.courts.com/trinidadandtobago/"
    PAGE_SIZE = 200
    MAX_PAGES = 300
