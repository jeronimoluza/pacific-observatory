...
EAP_COUNTRIES: frozenset[str] = frozenset({
    ...
    "china", "hong_kong", "hong_kong_sar_china", "japan",
    "korea_dem_peoples_rep", "macao_sar_china", "macao", "mongolia",
    "south_korea", "korea", "taiwan", "taiwan_china",
    # pacific_islands
    "american_samoa", "australia", "fiji", "french_polynesia", "guam",
    "kiribati", "marshall_islands", "micronesia_fed_sts", "nauru",
    "new_caledonia", "new_zealand", "northern_mariana_islands", "palau",
    "papua_new_guinea", "samoa", "solomon_islands", "tonga", "tuvalu",
    "vanuatu",
    # southeast_asia
    "brunei", "brunei_darussalam", "cambodia", "indonesia", "lao_pdr",
