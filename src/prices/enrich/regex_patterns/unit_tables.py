...
UNIT_NORM: Mapping[str, str] = {
    ...
    "мл": "ml",
    "л": "l",
    # Hebrew, Thai and Arabic/Persian mass/volume abbreviations. Same rationale
    # as the Cyrillic block: these scripts had no measure surface at all, so a
    # name that stated its pack size resolved to pricing_basis=item.
    "גרם": "g",
    "גר": "g",
    "ג": "g",
    "กรัม": "g",
