"""Generate a standalone dashboard HTML with a Policy Tracker tab plus the
...
POLICY_TRACKER_HTML = Path(
    os.environ.get(
        "POLICY_TRACKER_HTML",
        str(Path(__file__).resolve().parents[3] / "EAP_Policy_Tracker@2.html"),
    )
)
...
def generate_dashboard(
    ...
    dashboard_path = output_dir / "small_dashboard_integrated_w_policy.html"
