...
Log path: logs/{pipeline}/{region}/{subregion}/{country}/{source}/{date}/{datetime}.log
"""
...
def setup_logger(
    ...
    """Create a file logger at logs/{pipeline}/{region}/{subregion}/{country}/{source}/{date}/{datetime}.log.
