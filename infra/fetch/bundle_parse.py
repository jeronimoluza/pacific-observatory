...
# Relative to this file, not an absolute path into one developer's checkout:
# the bundle has to be built from the repo that is being deployed, or the fleet
# silently runs parse tiers from somewhere else.
REPO = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
SRC = os.environ.get("PARSE_SRC") or os.path.join(
    REPO, "src", "prices", "price_scraping", ""
)
